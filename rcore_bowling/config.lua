Config = {
	...
	Text = {
		...
		JOIN_LANE = '~INPUT_PICKUP~ Joindre le jeu',
		PLAY = '~INPUT_PICKUP~ Jouer',
		OPEN = '~INPUT_PICKUP~ Ouvrir',
		TAKE_BALL = '~INPUT_PICKUP~ Prendre la boule',

		NOT_IN_GAME = 'Vous ne jouez actuellement pas au bowling.',
		NOT_ENOUGH_MONEY = 'Vous n\'avez pas assez d\'argent pour payer.',
		INPUT_POSITION = 'Selection la position initiale de ~y~la boule de bowling~s~',
		INPUT_ROTATION = 'Selection la rotation de la ~y~boule de bowling~s~',
		INPUT_ANGLE = 'Selection ~y~angle~s~',
		INPUT_POWER = 'Selection ~y~puissance~s~',
		
        TOTAL = "Total",
        MATCH_END = "Match terminé en {0} secondes",
