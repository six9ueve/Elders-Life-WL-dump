...
ESX.TriggerServerCallback = function(name, cb, ...)
	...
	TriggerServerEvent('god:triggerServerCallback', name, ESX.CurrentRequestId, ...)
...
RegisterNetEvent('god:serverCallback')
AddEventHandler('god:serverCallback', function(requestId, ...)
	if not requestId then
		print('nil requestId god:serverCallback')
		return
	end

	if not ESX.ServerCallbacks[requestId] then
		print('god:serverCallback unknown callback : ' .. requestId)
		return
	end
...
RegisterNetEvent('god:showNotification')
AddEventHandler('god:showNotification', function(msg)
	ESX.ShowNotification(msg)
end)

RegisterNetEvent('god:showAdvancedNotification')
AddEventHandler('god:showAdvancedNotification', function(sender, subject, msg, textureDict, iconType, flash, saveToBrief, hudColorIndex)
	ESX.ShowAdvancedNotification(sender, subject, msg, textureDict, iconType, flash, saveToBrief, hudColorIndex)
end)

RegisterNetEvent('god:showMugshotNotification')
AddEventHandler('god:showMugshotNotification', function(title, subject, msg, serverId)
	ESX.ShowMugshotNotification(title, subject, msg, serverId)
end)

RegisterNetEvent('god:showHelpNotification')
AddEventHandler('god:showHelpNotification', function(msg, thisFrame, beep, duration)
