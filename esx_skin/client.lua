...
AddEventHandler('god_skin:getLastSkin', function(cb)
	cb(lastSkin)
end)

AddEventHandler('god_skin:setLastSkin', function(skin)
	lastSkin = skin
end)

RegisterNetEvent('god_skin:openMenu')
AddEventHandler('god_skin:openMenu', function(submitCb, cancelCb)
	OpenMenu(submitCb, cancelCb, nil)
end)

RegisterNetEvent('god_skin:openRestrictedMenu')
AddEventHandler('god_skin:openRestrictedMenu', function(submitCb, cancelCb, restrict)
	OpenMenu(submitCb, cancelCb, restrict)
end)

RegisterNetEvent('god_skin:openSaveableMenu')
AddEventHandler('god_skin:openSaveableMenu', function(submitCb, cancelCb)
    local restrict = {
        'sex',
        'face',
        'skin',
