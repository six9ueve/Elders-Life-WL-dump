...
ConfigMission = {}
ConfigMission.CooldownTimer = 15
ConfigMission.PayoutForFirstOrder = 11500
ConfigMission.PayoutForSecondOrder = 4000
ConfigMission.PayoutForThirdOrder = 10250
ConfigMission.PayoutForFourthOrder = 6600
ConfigMission.PayoutForFifthOrder = 7500
ConfigMission.PayoutForSixthOrder = 9500
ConfigMission.PayoutForSeventhOrder = 8500

ConfigMission.illegalorders = {
	['BossSpawn'] = { --the place where you start and finish your work
		Pos = {x = -106.4926, y = -2230.216, z = 6.81, h = 89.69},
		Type  = 'g_m_m_mexboss_01',
	},
}

ConfigMission.Orders = {
    {name = 'first'},
    {name = 'second'},
    {name = 'third'},
    {name = 'fourth'},
...
ConfigMission.FirstOrder = {
    ['CarSpawn'] = {
        ...
        [2] = {         
            Pos = {x = -1866.059, y = -352.298, z = 49.22, h = 46.43},
            Type  = 'windsor',
            Peds = {['Peds'] = {
                [1]={x=-1863.917,y=-346.65,z=49.83,h=114.63,ped},
                [2]={x=-1855.602,y=-353.2656,z=49.83,h=132.69,ped},
                [3]={x=-1864.229,y=-362.868,z=49.29,h=324.21,ped},
                [4]={x=-1872.545,y=-355.44,z=49.31,h=315.396,ped},
            }},
        },
        [3] = {         
    ...
    ['BackCar'] = {
        Pos = {x = -450.066, y = -51.67, z = 43.515, h = 57.00},
    }
}

ConfigMission.SecondOrder = {
    ['PedSpawn'] = {
        [1] = {         
        ...
        [4] = {         
            Pos = {x = 314.52, y = -1574.83, z = 29.69, h = 102.96},
            Type  = 's_m_y_dealer_01',
        },
    },
}

ConfigMission.ThirdOrder = {
    ['PedSpawn'] = {
        [1] = {         
