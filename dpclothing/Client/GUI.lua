...
local function DrawGUI()
	...
	if InfoButton and not pressbutton then 
		ESX.ShowNotification('~y~[Staff]~s~ : Vous avez repris votre personnage, le menu est bloqué 10 secondes !')
		pressbutton = true		
...
RegisterNetEvent('god_handcuffs:cuffedmenuy')
AddEventHandler('god_handcuffs:cuffedmenuy', function()
	dpcuffed = not dpcuffed
end)