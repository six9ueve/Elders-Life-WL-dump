...
Citizen.CreateThread(function()
	...
	AddNewVariation("Hair", "Male", 9, 15, true)
	AddNewVariation("Hair", "Male", 11, 152, true)
	AddNewVariation("Hair", "Male", 15, 9, true)
	AddNewVariation("Hair", "Male", 16, 31, true)
	AddNewVariation("Hair", "Male", 20, 42, true)
	AddNewVariation("Hair", "Male", 22, 23, true)
	AddNewVariation("Hair", "Male", 23, 22, true)
	AddNewVariation("Hair", "Male", 31, 16, true)
	AddNewVariation("Hair", "Male", 42, 20, true)
	AddNewVariation("Hair", "Male", 43, 127, true)
	AddNewVariation("Hair", "Male", 127, 43, true)
	AddNewVariation("Hair", "Male", 52, 67, true)
	AddNewVariation("Hair", "Male", 67, 52, true)
	AddNewVariation("Hair", "Male", 53, 9, true)
	AddNewVariation("Hair", "Male", 56, 61, true)
	AddNewVariation("Hair", "Male", 61, 46, true)
	AddNewVariation("Hair", "Male", 58, 64, true)
	AddNewVariation("Hair", "Male", 64, 58, true)
	AddNewVariation("Hair", "Male", 152, 11, true)
	-- Female Hair
	AddNewVariation("Hair", "Female", 1, 45, true)
	AddNewVariation("Hair", "Female", 2, 47, true)
	AddNewVariation("Hair", "Female", 4, 6, true)
	AddNewVariation("Hair", "Female", 5, 7, true)
	AddNewVariation("Hair", "Female", 8, 37, true)
	AddNewVariation("Hair", "Female", 10, 11, true)
	AddNewVariation("Hair", "Female", 15, 81, true)
	AddNewVariation("Hair", "Female", 17, 19, true)
	AddNewVariation("Hair", "Female", 18, 52, true)
	AddNewVariation("Hair", "Female", 21, 51, true)
	AddNewVariation("Hair", "Female", 22, 94, true)
	AddNewVariation("Hair", "Female", 23, 26, true)
	AddNewVariation("Hair", "Female", 24, 33, true)
	AddNewVariation("Hair", "Female", 25, 26, true)
	AddNewVariation("Hair", "Female", 27, 32, true)
	AddNewVariation("Hair", "Female", 28, 51, true)
	AddNewVariation("Hair", "Female", 29, 32, true)
	AddNewVariation("Hair", "Female", 45, 1, true)
	AddNewVariation("Hair", "Female", 47, 2, true)
	AddNewVariation("Hair", "Female", 6, 4, true)
	AddNewVariation("Hair", "Female", 7, 5, true)
	AddNewVariation("Hair", "Female", 37, 8, true)
	AddNewVariation("Hair", "Female", 11, 10, true)
	AddNewVariation("Hair", "Female", 81, 15, true)
	AddNewVariation("Hair", "Female", 19, 17, true)
	AddNewVariation("Hair", "Female", 52, 18, true)
	AddNewVariation("Hair", "Female", 51, 21, true)
	AddNewVariation("Hair", "Female", 94, 22, true)
	AddNewVariation("Hair", "Female", 26, 23, true)
	AddNewVariation("Hair", "Female", 33, 24, true)
	AddNewVariation("Hair", "Female", 32, 27, true)
