...
-- Variables (HUD)
Config.maxPlayers   = 256 -- Keep same as sv_maxclients within your server.cfg.
Config.hideArmor    = true
Config.hideOxygen   = true

Config.pulseHud     = false -- Pulse Effect when status is below the configured amount.
...
Config.oxygenMax    = 2.5 -- Set to 10 / 4 if using vMenu

-- Variables (Framework)
Config.useESX       = true -- Change ESX config to true to use ESX (change ./html/js/config.js Config.useESX to true too)
Config.useStress    = true -- Use ESX stress by Utku (https://github.com/utkuali/Stress-System-by-utku)
