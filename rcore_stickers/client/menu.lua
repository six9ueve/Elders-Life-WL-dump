...
local defaultStyle = {
	...
	titleBackgroundColor = { 114, 204, 114, 255 }, --{ 174, 219, 242, 255 },
	titleBackgroundSprite = nil,
	subTitleColor = { 114, 204, 114, 255 },
...
function WarMenu.CreateMenu(id, title, subTitle, style)
	...
	menu.currentOption = 1
	menu.title = title
	menu.subTitle = subTitle and subTitle or 'INTERACTION MENU'
...
function WarMenu.CreateSubMenu(id, parent, subTitle, style)
	...
	WarMenu.CreateMenu(id, parentMenu.title, subTitle and subTitle or parentMenu.subTitle)
