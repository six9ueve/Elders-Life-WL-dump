Locales['fr'] = {
  ...
  ['secondary_employee_management'] = 'gestion organisation',
  ['fire']                   = 'licencier',
  ['grade']                  = 'grade',
  ['have_deposited']         = 'vous avez déposé ~r~$%s~s~',
  ['have_withdrawn']         = 'vous avez retiré ~g~$%s~s~',
  ['invalid_amount']         = 'montant invalide',
  ['invalid_wash']           = 'Il y as déja un blanchiement en cours...',
  ['invalid_amount_wash']    = 'montant invalide ( ~r~Max 12000$~s~ )',
  ['invalid_amount_wash_orga']= 'montant invalide ( ~r~Max 500 000$~s~ )',
  ...
  ['wash_money_orga']        = 'blanchir argent (orga)',
  ['wash_money_amount']      = 'montant à blanchir',
  ['withdraw_amount']        = 'montant du retrait',
  ['withdraw_society_money'] = 'retirer argent société',
  ['yes']                    = 'oui',
  ['you_have']               = 'Vous placer votre argent,qui est en attente de ~r~blanchiement~s~ ( 24h-72h ).',
