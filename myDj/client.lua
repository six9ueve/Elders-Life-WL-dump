...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        for k, v in pairs(Config.DJPositions) do
            if (not Config.useESX or v.requiredJob == nil or ESX ~= nil and PlayerData.job ~= nil and PlayerData.job.name == v.requiredJob or PlayerData.job2 ~= nil and PlayerData.job2.name == v.requiredJob) then
