UTK = {}
UTK.timer = 70 -- countdown to secure lock in seconds (time needed to pass to door to be closed back)
UTK.hacktime = 25000 -- first door open delay to make time for police to arrive and roleplay in miliseconds (I highly recommend to leave it be (2.5 min default))
UTK.maxcash = 2000 -- maximum amount of cash a pile can hold
UTK.mincash = 1000 -- minimum amount of cash a pile holds
UTK.black = true -- enable this if you want blackmoney as a reward
UTK.cooldown = 4000 -- amount of time to do the heist again in seconds (15min)
