...
Config.RetroMachine = {
    ...
    {
        name = "X Rock (No Twitch)",
        link = string.format("nui://rcore_arcade/html/msdos.html?url=%s&params=%s", "https://www.retrogames.cz/dos/zip/XRock.zip", "./VXROCK.EXE"),
    },
}
...
Config.GamingMachine = {
    ...
    {
        name = "Pingouin",
        link = "https://html5.gamedistribution.com/6579901571e94ea38ecec1a7b709850e/?gd_sdk_referrer_url=https%3A%2F%2Fwww.jeux-gratuits.com%2Fjeu-yeti-et-pingouins.html",
    },
    {
        name = "Ants",
    ...
    {
        name = "15 Puzzle (No Twitch)",
        link = string.format("nui://rcore_arcade/html/msdos.html?url=%s&params=%s", "https://www.retrogames.cz/dos/zip/15Puzzle.zip", "./MOVEHOLE.EXE"),
    }
}
