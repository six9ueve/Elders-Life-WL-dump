    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                local ListText = (type(Items[Index[Option].Current]) == "table") and string.format("← %s →", Items[Index[Option].Current].label) or string.format("← %s →", Items[Index[Option].Current]) or "NIL"
